...
{
    public class TaskExecutorMerlinHoYoVerse : TaskExecutorBase
    {
        ...
        public TaskExecutorMerlinHoYoVerse(string game_biz, string lang, string cookie) : base(game_biz, lang, cookie) { }
        ...
        {
            string doTaskUrl = string.Format(doTaskUrlTemplate, taskId, game_biz);
